...
# folder_name = 'evaluations/xgb_rf'
...
# csv_files = [
#     ('mae.csv', ['fname', 'xgb', 'rf', 'xgb_rf']),
#     ('mape.csv', ['fname', 'xgb', 'rf', 'xgb_rf']),
#     ('mse.csv',['fname', 'xgb', 'rf', 'xgb_rf']),
#     ('rmse.csv', ['fname', 'xgb', 'rf', 'xgb_rf'])
# ]
...
#     hybrid = evaluate_xgboost_and_random_forest(df_arg=df, exog=exog, lag_value=lags)
...
#     new_row_mae = pd.DataFrame([[filename, results_xgb['mae'], results_rf['mae'], hybrid['mae']]], columns=['fname','xgb', 'rf','xgb_rf'])
#     new_row_mape = pd.DataFrame([[filename, results_xgb['mape'], results_rf['mape'], hybrid['mape']]], columns=['fname','xgb', 'rf','xgb_rf'])
#     new_row_mse = pd.DataFrame([[filename, results_xgb['mse'], results_rf['mse'], hybrid['mse']]], columns=['fname','xgb', 'rf','xgb_rf'])
#     new_row_rmse = pd.DataFrame([[filename, results_xgb['rmse'], results_rf['rmse'], hybrid['rmse']]], columns=['fname','xgb', 'rf','xgb_rf'])
