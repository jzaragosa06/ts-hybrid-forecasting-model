...
from hybridModels.xgb_lasso_enr_dt import evaluate_xgb_and_lasso_enr_dt
...
eval_directory = os.path.join(base_directory, 'evaluations', 'xgb_lasso_enr_dt')
...
csv_files = [
    ("mae.csv", ["fname", "xgb", "lasso", "enr", "dt", "ridge_lasso_enr_dt"]),
    ("mape.csv", ["fname", "xgb", "lasso", "enr", "dt", "ridge_lasso_enr_dt"]),
    ("mse.csv", ["fname", "xgb", "lasso", "enr","dt", "ridge_lasso_enr_dt"]),
    ("rmse.csv", ["fname", "xgb", "lasso", "enr","dt", "ridge_lasso_enr_dt"]),
]
...
for filename in os.listdir(data_directory):
    ...
    hybrid = evaluate_xgb_and_lasso_enr_dt(
        df_arg=df, exog=exog, lag_value=lags
    )

    csv_mae = os.path.join(base_directory, 'evaluations', 'xgb_lasso_enr_dt', 'mae.csv')
    csv_mape = os.path.join(base_directory, 'evaluations', 'xgb_lasso_enr_dt', 'mape.csv')
    csv_mse = os.path.join(base_directory, 'evaluations', 'xgb_lasso_enr_dt', 'mse.csv')
    csv_rmse = os.path.join(base_directory, 'evaluations', 'xgb_lasso_enr_dt', 'rmse.csv')
    ...
    new_row_mae = pd.DataFrame(
        ...
        columns=["fname", "xgb", "lasso", "enr", "dt", "ridge_lasso_enr_dt"],
    )
